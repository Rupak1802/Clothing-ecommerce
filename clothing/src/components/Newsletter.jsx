...
export default function Newsletter() {
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
      <div className="relative overflow-hidden rounded-3xl bg-[#111111] px-6 py-16 sm:px-12 sm:py-20 lg:px-20 shadow-xl">
          ...
          <AnimatePresence mode="wait">
            {status !== "success" ? (
              ...
              >
                ...
                <p className="mx-auto mt-4 max-w-md text-xs sm:text-sm font-light leading-relaxed text-white/70">
                ...
                <form onSubmit={handleSubmit} className="mt-8">
                  ...
                  {status === "error" && (
                    <motion.p
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      className="mt-3 text-[11px] text-red-400 font-semibold uppercase tracking-wider"
                    >
              ...
              >
                ...
                <p className="mt-2 text-xs sm:text-sm font-light text-white/70 max-w-sm leading-relaxed">
