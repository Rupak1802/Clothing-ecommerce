            ...
            >
                ...
                <AnimatePresence initial={false}>
                  {cartItems.length === 0 ? (
                    ...
                    >
                      ...
                      <button
                        onClick={onClose}
                        className="mt-6 rounded-xl bg-primary px-6 py-2.5 text-xs font-semibold uppercase tracking-widest text-white shadow-md hover:bg-primary/90 transition-colors cursor-pointer"
                      >
                        Start Shopping
                      </button>
                    </motion.div>
              ...
              {cartItems.length > 0 && (
                <div className="border-t border-border bg-bg-tertiary p-6">
                  ...
                  <button
                    onClick={onCheckout}
                    className="mt-6 flex w-full items-center justify-center gap-2 rounded-xl bg-primary py-3.5 text-xs font-semibold uppercase tracking-widest text-white shadow-md hover:bg-primary/90 transition-colors cursor-pointer"
                  >
                    Proceed to Checkout
                    <ArrowRight size={14} />
                  </button>
